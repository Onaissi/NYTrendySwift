...
public class SideMenuManager : NSObject {
     ...
     */
    public var menuPushStyle: MenuPushStyle = .defaultBehavior
     ...
     */
    public var menuPresentMode: MenuPresentMode = .viewSlideOut
    
    /// Prevents the same view controller (or a view controller of the same class) from being pushed more than once. Defaults to true.
    public var menuAllowPushOfSameClassTwice = true
     ...
     */
    public var menuWidth: CGFloat = min(round(min((appScreenRect.width), (appScreenRect.height)) * 0.75), 240)
    
    /// Duration of the animation when the menu is presented without gestures. Default is 0.35 seconds.
    public var menuAnimationPresentDuration: Double = 0.35
    
    /// Duration of the animation when the menu is dismissed without gestures. Default is 0.35 seconds.
    public var menuAnimationDismissDuration: Double = 0.35
    
    /// Duration of the remaining animation when the menu is partially dismissed with gestures. Default is 0.35 seconds.
    public var menuAnimationCompleteGestureDuration: Double = 0.35
    
    /// Amount to fade the existing view controller when the menu is presented. Default is 0 for no fade. Set to 1 to fade completely.
    public var menuAnimationFadeStrength: CGFloat = 0
    ...
    public var menuAnimationTransformScaleFactor: CGFloat = 1
    ...
    public var menuShadowOpacity: Float = 0.5
    ...
    public var menuShadowRadius: CGFloat = 5
    ...
    public var menuPresentingViewControllerUserInteractionEnabled: Bool = false
    ...
    public var menuParallaxStrength: Int = 0
    
    /// Draws the `menuAnimationBackgroundColor` behind the status bar. Default is true.
    public var menuFadeStatusBar = true
    
    /// The animation options when a menu is displayed. Ignored when displayed with a gesture.
    public var menuAnimationOptions: UIView.AnimationOptions = .curveEaseInOut
    
    /// The animation spring damping when a menu is displayed. Ignored when displayed with a gesture.
    public var menuAnimationUsingSpringWithDamping: CGFloat = 1
    
    /// The animation initial spring velocity when a menu is displayed. Ignored when displayed with a gesture.
    public var menuAnimationInitialSpringVelocity: CGFloat = 1
     ...
     */
    public var menuDismissOnPush = true
    
    /// Forces menus to always animate when appearing or disappearing, regardless of a pushed view controller's animation.
    public var menuAlwaysAnimate = false
    ...
    public var menuEnableSwipeGestures: Bool = true {
        didSet {
     ...
     */
    @discardableResult public func menuAddScreenEdgePanGesturesToPresent(toView: UIView, forMenu:UIRectEdge? = nil) -> [UIScreenEdgePanGestureRecognizer] {
     ...
     */
    @discardableResult public func menuAddPanGestureToPresent(toView: UIView) -> UIPanGestureRecognizer {
...
extension SideMenuManager {
    ...
    @discardableResult public class func menuAddScreenEdgePanGesturesToPresent(toView: UIView, forMenu:UIRectEdge? = nil) -> [UIScreenEdgePanGestureRecognizer] {
    ...
    @discardableResult public class func menuAddPanGestureToPresent(toView: UIView) -> UIPanGestureRecognizer {
